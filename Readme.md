...
Application Database (Managed via Kubernetes Operator)
Prometheus / Grafana
Monitoring, Alerting, and Visualization (Observability)
NGINX Gateway Fabric
Kubernetes Ingress and Traffic Management (Gateway API)
cert-manager
...
Deploy and Configure the PostgreSQL Database
...
Configure Network Routing via Gateway API
...
Insecure Argo CD Access: The command kubectl patch configmap... --patch '{"data":{"server.insecure":"true"}}' disables TLS for the Argo CD server, exposing login credentials and session data over the network.1
...
Works cited
kubesimplify/devops-project: This is the repo for DevOps ... - GitHub, accessed on July 15, 2025, https://github.com/kubesimplify/devops-project
